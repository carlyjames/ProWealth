...
<head>
    ...
    <title>BitpullseTrade | Forgot your password</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-3 mb-0">
                                            ...
                                            <a href="SignIn.php" class="text-dark font-weight-bold">Login</a>
                                        </p>
                                    </div>
                                    <!--end col-->
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-4 mb-0">
                                            <small class="mr-2 text-dark">&copy; Copyright 2022 &nbsp; BinaWealth
                                                &nbsp; All
