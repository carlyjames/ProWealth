  ...
  (function () {
    ...
    $("#perfomanceChart").length &&
      ...
      $("#totalSale").length &&
        ((e = {
          series: [45, 38, 28, 15],
          labels: ["Direct", "Affiliate", "pussy", "E-mail"],
          colors: ["#3b82f6", "#0EA5E9", "#DC3545", "#F59E0B"],
      ...
      $("#locationmap").length &&
        new jsVectorMap({
          ...
          markerStyle: { initial: { fill: ["#3b82f6"] } },
          markerLabelStyle: {
            initial: {
              fontFamily: "Inter",
              fontSize: 13,
      ...
      $("#taskSectionchart").length &&
        ((e = {
          ...
          colors: ["#3b82f6", "#198754", "#0ea5e9", "#f59e0b"],
        }),
        new ApexCharts(
