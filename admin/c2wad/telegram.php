...
if (isset($_POST['ubank'])) {
  ...
  $tele = $link->real_escape_string($_POST['tele']);




  $sql = "UPDATE admin SET telegram='$tele'";
    ...
    <div class="col-md-12 col-sm-12 col-sx-12">
      <div class="box box-default">
        <div class="box-header with-border">
          ...
          <h4 align="center"><i class="fa fa-plus"></i> TELEGRAM MANAGEMENT</h4>
          </br>
          ...
          <div class="box-header with-border">
            ...
            <form class="form-horizontal" action="telegram.php" method="POST">

              <legend>Update Telegram Details</legend>



              <div class="form-group">
                <label>Telegram Link</label>
                <input type="text" name="tele" value="<?php echo $bw; ?>" placeholder="Telegram Link" class="form-control">
              </div>
